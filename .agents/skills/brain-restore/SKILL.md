---
name: brain-restore
description: Verify and restore an encrypted Main Brain snapshot into a new empty directory. Use for a new workstation, recovery test, or explicit disaster recovery request.
---
...
2. Run `scripts/restore.ps1 -Archive "<file>" -Destination "<path>"`.
