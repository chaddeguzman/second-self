---
name: brain-recall
description: Retrieve personal facts, preferences, decisions, commitments, lessons, or history from Main Brain. Use when an answer should rely on stored personal context or when the user asks what was previously recorded.
---
