...
This boundary includes `03-wiki`, Raw sources, wiki transaction journals, and
generated source pages. Only empty scaffolds and reusable instructions may be
tracked.
...
Raw-to-References moves use the same single approval as other protected
